...
<p className="text-left text-xl w-full my-4">I’m passionate about using software to create meaningful products and experiences. You can check out my #buildinginpublic at my <a href="http://twitter.com/harrizontal" className="underline" target="_blank">Twitter</a> where I build interesting (and sometimes weird) software products such as <a href="http://frablube.com" className="underline" target="_blank">Frablube.com</a>, and occasionally retweet memes. Sometimes, I also do blogging on life and tech at <a href="http://harrizontal.com" className="underline" target="_blank">harrizontal.com</a>.</p>

<p className="text-left text-xl w-full my-4">In my previous job, I'm Android Engineer for <a href="http://www.mindfi.co" className="underline" target="_blank">MindFi (YC21)</a> where I headed the migration from Flutter to Native Android Kotlin. I also headed and involved (heavily) in other engineering and product related initiatives such as instrumenting of product analytics, data analytics, internal tools, dashboard and report generation.</p>
